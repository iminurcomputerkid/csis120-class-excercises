...
public class Word {
     ...
     * 
     * @param word            The word.
     * @param pOfSp           The part of speech for the word. (E.g., noun, verb,
     *                        etc.)
    ...
    public String removeDefinition(int defNumber) {
        String result = "Error - no such definition.";

        if (defNumber <= definitions.size()) {
            result = definitions.remove(defNumber - 1);
        }
